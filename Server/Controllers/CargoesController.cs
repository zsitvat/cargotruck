...
namespace Cargotruck.Server.Controllers
{
    ...
    public class CargoesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetCargoesAsync()
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostAsync(Cargoes data)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> PutAsync(Cargoes data)
        {
