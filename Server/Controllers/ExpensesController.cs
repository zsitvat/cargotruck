...
namespace Cargotruck.Server.Controllers
{
    ...
    public class ExpensesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAsync(int page, int pageSize, string sortOrder, bool desc, string? searchString, Type? filter, DateTime? dateFilterStartDate, DateTime? dateFilterEndDate)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> PageCountAsync(string? searchString, Type? filter, DateTime? dateFilterStartDate, DateTime? dateFilterEndDate)
        {
            var data = await GetDataAsync(searchString, filter, dateFilterStartDate, dateFilterEndDate);
        ...
        [HttpPost]
        public async Task<IActionResult> PostAsync(Expenses data)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> PutAsync(Expenses data)
        {
            data.Total_amount = GetTotalAmount(data);
