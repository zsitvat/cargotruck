...
namespace Cargotruck.Client.Pages.Cargoes
{
    public partial class FetchData
    {
        ...
        protected async Task ShowPage()
        {
            ...
            Cargoes = await client.GetFromJsonAsync<Cargotruck.Shared.Models.CargoesDto[]>($"api/cargoes/get?page={currentPage}&pageSize={pageSize}&sortOrder={sortOrder}&desc={desc}&searchString={searchString}&filter={filter}&dateFilterStartDate={dateFilter?.StartDate}&dateFilterEndDate={dateFilter?.EndDate}");
            StateHasChanged();
        }
